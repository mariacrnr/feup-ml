...
trans_df = pd.read_csv('./raw/trans_comp.csv', delimiter=';', low_memory=False)
loan_df = pd.read_csv('./raw/loan_comp.csv', delimiter=';')
card_df = pd.read_csv('./raw/card_comp.csv', delimiter=';')
...
trans_df = trans_df.drop(columns=['account'])
...
dev_df = pd.read_csv("processed/data_5it.csv")

df = df[dev_df.columns]

csv = df.to_csv(index = False)
os.makedirs("processed", exist_ok=True)
path = "{}/{}".format("processed", "comp_5it.csv")
